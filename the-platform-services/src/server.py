...
from com.platform.health.diabetes.web.diabetes import DiabetesController, DiabetesDataSetController, \
    DiabetesDataTestController, RegistrationController, DiabetesTrainingController
